...
os.environ["CPP_STATE_VARIANT"] = "local_memory_decay_v2"
os.environ["CPP_REWARD_VARIANT"] = "late_finish_v1"
os.environ["CPP_LOCAL_VIEW_SIZE"] = "3"
os.environ["CPP_MEMORY_DECAY"] = "0.92"
os.environ["CPP_MEMORY_TRACE_GAIN"] = "0.40"
...
MODEL_PATH = Path("data/20x20_experiments/MERLIN_2020.zip")
OUTPUT_PATH = Path("Graficos/20_merlin_2020_20x20.gif")
...
def sample_frames(frames, max_frames=150):
...
def main():
    ...
    save_gif(frames)
    print(f"MERLIN_2020 20x20: success={success} coverage={coverage:.2%} steps={steps} seed={seed}")
    pygame.quit()
